...
<body
	...
	<table class="type05">
		...
		<tr>
			...
			<input type="hidden" name="addressNum" value="<%=address.getAddressNum()%>">
	...
	<button onclick="location.href='insertAddress.jsp'" class="btn btn-outline-secondary">주소추가</button>
	</div>
</body>
</html>