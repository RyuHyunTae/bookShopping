...
<body
	...
	<form action="insertCreditcard.do" method="post">
		<table class="type05">
			<tr>
				<td>카드번호</td>
				<td><input type="text" name="creditcardNum" class="form-control"></td>
			</tr>
			<tr>
				<td>카드유효기간</td>
			...
			<tr>
				<td>카드종류</td>
				<td><input type="text" name="creditcardKind" class="form-control"></td>
			</tr>
		</table>
		<input type="hidden" name="id" value="<%=id%>"> 
		<input type="submit" value="카드등록" class="btn btn-outline-secondary">
	</form>
	</div>
</body>
</html>