...
<body
	...
	<div style="margin: 0 auto;" align="center">
				...
				<td align="center"><form action="oneOrder.do" method="post">
						<input type="hidden" name="bookNum"
							...
							<input type="hidden" name="id" value="<%=id%>">
							 <input type="submit"
							value="구매" class="btn btn-outline-secondary">
					</form></td>
			...
			<tr>
				...
				<td align="center"><form action="insertBasket.do" method="post">
						<input type="hidden" name="bookNum"
							...
							value="장바구니" class="btn btn-outline-secondary">
					</form></td>
			</tr>
			<%
				} else {
			...
			<tr>
				...
				<td align="center">
					<button
						...
						class="btn btn-outline-secondary">수정</button></td>
			...
			<tr>
				...
				<td align="center"><form action="deleteBook.do" method="post">
						<input type="hidden" name="bookNum"
							...
							value="삭제" class="btn btn-outline-secondary">
					</form></td>
			</tr>
		...
		<input type="text" name="grade2" placeholder="1~5점 입력하세요">
		<input type="hidden" name="id" value="<%=id%>">
